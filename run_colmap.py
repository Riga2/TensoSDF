...
def main():
    ...
    parser.add_argument('--project_dir', type=str, default='/nerf_data/nero_real/casserole')
    parser.add_argument('--colmap', type=str, default='/home/czl/Desktop/colmap/build/src/colmap/exe/colmap')
    parser.add_argument('--same_camera', action='store_true', default=True, dest='same_camera')
